...
.sales-modal-body .ann-matrix .td-name { white-space: normal; font-size: 14px; line-height: 1.4; font-weight: 600; color: #1e293b; direction: ltr; unicode-bidi: normal; transform: none; }
.sales-modal-body .ann-matrix .row-sub .td-name { font-size: 13px; font-weight: 500; color: #475569; padding-left: 16px; direction: ltr; unicode-bidi: normal; }
